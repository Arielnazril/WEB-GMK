...
{{-- Unit Section --}}
<section id="unit" class="py-24 md:py-40 px-6 bg-white relative">
    <div class="max-w-7xl mx-auto">
        <div class="text-center mb-16 md:mb-24">
            <h2 class="text-3xl md:text-6xl font-black text-blue-950 mb-6">Unit Pendidikan</h2>
            <div class="w-16 md:w-24 h-2 bg-gradient-to-r from-blue-600 to-emerald-400 mx-auto rounded-full"></div>
        </div>
...
{{-- Call to Action --}}
<section class="py-16 md:py-24 px-4 md:px-6 bg-slate-50">
    <div class="max-w-6xl mx-auto relative rounded-[2.5rem] md:rounded-[4rem] bg-blue-600 overflow-hidden p-8 md:p-20 text-center shadow-2xl">
        <div class="absolute top-0 right-0 w-64 h-64 md:w-96 md:h-96 bg-white/10 rounded-full blur-[80px] -mr-32 -mt-32"></div>
        
        <div class="relative z-10">
            <h2 class="text-3xl md:text-6xl font-black text-white mb-6 md:mb-8">Siap Bergabung?</h2>
            <p class="text-blue-100 text-sm md:text-xl mb-10 md:mb-14 max-w-2xl mx-auto leading-relaxed">
