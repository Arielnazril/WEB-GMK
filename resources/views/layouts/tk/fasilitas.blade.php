        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 items-center">
            <div class="space-y-6 md:space-y-8 text-center lg:text-left">
                ...
                <p class="text-slate-600 text-base md:text-xl leading-relaxed max-w-xl mx-auto lg:mx-0">
                    Kami menyediakan sarana prasarana yang dirancang khusus untuk mendukung keamanan dan kreativitas anak dalam mengeksplorasi minat bakat mereka.
                </p>
                ...
                <div class="relative w-full max-w-xs md:max-w-lg group">
                    ...
                    <div class="relative bg-white p-4 md:p-6 rounded-[35px] md:rounded-[50px] shadow-2xl transition-all duration-500 group-hover:-translate-y-2">
                        <div class="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-[30px] md:rounded-[40px] aspect-[4/3] flex flex-col items-center justify-center border-2 md:border-4 border-dashed border-yellow-200 overflow-hidden relative">
                            <i class="fas fa-shapes text-yellow-400 text-6xl md:text-8xl"></i>
...
<div class="bg-slate-50 py-20 md:py-32">
    <div class="max-w-7xl mx-auto px-6 text-center">
        <h3 class="text-3xl md:text-4xl font-black text-slate-900 mb-12 md:mb-16 uppercase tracking-tighter">Sarana & Prasarana</h3>
        ...
        <div class="grid grid-cols-2 lg:grid-cols-3 gap-4 md:gap-10">
            ...
            <div class="group bg-white p-6 md:p-10 rounded-[30px] md:rounded-[50px] shadow-sm border border-slate-100 hover:shadow-xl transition-all duration-500 flex flex-col items-center">
                <div class="w-14 h-14 md:w-20 md:h-20 bg-{{ $item['color'] }}-50 text-{{ $item['color'] }}-500 rounded-2xl md:rounded-3xl flex items-center justify-center mb-4 md:mb-8 group-hover:scale-110 transition-transform shadow-sm">
...
<div class="py-20 md:py-32 max-w-7xl mx-auto px-6">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
        <div class="p-8 md:p-12 bg-yellow-50 rounded-[40px] md:rounded-[60px] border border-yellow-100 group hover:shadow-xl transition-all duration-500">
            ...
            <p class="text-slate-600 text-sm md:text-lg leading-relaxed mb-6 md:mb-8 font-medium">Tempat makan bersih untuk membiasakan adab makan yang baik dan konsumsi makanan bergizi.</p>
            <span class="inline-block px-4 py-2 bg-white rounded-full text-[8px] md:text-[10px] font-black text-yellow-600 uppercase tracking-widest shadow-sm">Healthy Habit</span>
        </div>
        ...
        <div class="p-8 md:p-12 bg-blue-50 rounded-[40px] md:rounded-[60px] border border-blue-100 group hover:shadow-xl transition-all duration-500">
            ...
            <p class="text-slate-600 text-sm md:text-lg leading-relaxed mb-6 md:mb-8 font-medium">Toilet dan wastafel seukuran anak kecil (kid-sized) untuk melatih kemandirian kebersihan diri.</p>
            <span class="inline-block px-4 py-2 bg-white rounded-full text-[8px] md:text-[10px] font-black text-blue-600 uppercase tracking-widest shadow-sm">Self Care Training</span>
        </div>
    </div>
</div>
