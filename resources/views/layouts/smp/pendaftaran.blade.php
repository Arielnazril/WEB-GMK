...
<div class="flex flex-col min-h-screen min-h-[100dvh] bg-slate-50">
    ...
    {{-- HERO SECTION --}}
    <div class="relative bg-blue-950 pt-20 pb-16 md:pt-32 md:pb-40 overflow-hidden w-full">
        {{-- Elemen Dekoratif --}}
        <div class="absolute top-0 left-1/4 w-72 h-72 md:w-96 md:h-96 bg-blue-600/20 blur-[120px] rounded-full animate-pulse"></div>
        <div class="absolute bottom-0 right-1/4 w-48 h-48 md:w-64 md:h-64 bg-sky-600/10 blur-[80px] rounded-full"></div>
        <div class="absolute inset-0 opacity-10" style="background-image: radial-gradient(#3b82f6 0.5px, transparent 0.5px); background-size: 24px 24px;"></div>
        
        <div class="max-w-7xl mx-auto px-5 relative z-10">
            <div class="max-w-3xl text-center md:text-left" data-aos="fade-right">
                <div class="inline-flex items-center gap-3 bg-blue-500/10 border border-blue-500/20 px-4 py-2 rounded-xl mb-6 hover:bg-blue-500/20 transition-all">
                    <span class="relative flex h-2 w-2">
                        <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-blue-400 opacity-75"></span>
                        <span class="relative inline-flex rounded-full h-2 w-2 bg-blue-500"></span>
                    </span>
                    <span class="text-blue-400 text-[10px] md:text-xs font-black uppercase tracking-[0.2em]">Admissions 2026/2027</span>
                </div>

                <h1 class="text-4xl md:text-8xl font-black text-white mb-6 leading-[1.1] tracking-tighter">
                    Mari <br class="hidden md:block">
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-sky-300 to-indigo-500 animate-gradient-x">Bergabung</span>
                </h1>
                <p class="text-slate-300 text-base md:text-xl leading-relaxed max-w-2xl mb-10 border-l-4 border-blue-500/30 pl-6 mx-auto md:mx-0 text-left">
            ...
            <nav class="relative group mt-10" data-aos="fade-up" data-aos-delay="200">
                <div class="absolute -inset-1 bg-gradient-to-r from-blue-600 to-sky-600 rounded-[2rem] blur opacity-20"></div>
                
                <div class="relative bg-slate-900/90 backdrop-blur-xl p-2 md:px-8 md:py-5 rounded-[2rem] border border-white/10 shadow-2xl">
                    <div class="flex flex-col lg:flex-row items-center justify-between gap-4">
                        ...
                        <div class="flex flex-row overflow-x-auto items-center gap-4 md:gap-10 w-full lg:w-auto no-scrollbar py-3 px-4 md:px-0">
                            @php
                                $menus = [
                                    ...
                                    ['url' => 'unit/smp/ekskul', 'num' => '03', 'label' => 'Ekstrakulikuler'],
                        ...
                        <div class="w-full lg:w-auto px-4 pb-3 lg:p-0">
                            <div class="bg-blue-600 text-white px-6 py-3 rounded-xl font-black text-[10px] md:text-xs uppercase tracking-widest text-center shadow-lg shadow-blue-500/20">
                                Pendaftaran Dibuka
                            </div>
                        </div>
                    </div>
    ...
    <div class="flex-grow py-12 md:py-16 px-5 w-full">
        <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-6 md:space-y-8">
                ...
                <div class="bg-white p-6 md:p-10 rounded-[2rem] shadow-sm border border-slate-100" data-aos="fade-up">
                    <h3 class="text-xl md:text-2xl font-black text-slate-900 mb-6 uppercase italic tracking-tighter flex items-center gap-3">
                        <i class="fas fa-clipboard-list text-blue-600"></i> Mekanisme Pendaftaran
                    </h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                        ...
                        <div class="flex gap-4 p-4 rounded-2xl bg-slate-50 border border-slate-100 group hover:border-blue-500 transition-colors">
                            <span class="flex-shrink-0 w-8 h-8 rounded-full bg-blue-600 text-white flex items-center justify-center font-black text-xs">
                                {{ $index + 1 }}
                            </span>
                ...
                <div class="bg-white p-6 md:p-10 rounded-[2rem] shadow-sm border border-slate-100" data-aos="fade-up">
                    <h3 class="text-xl md:text-2xl font-black text-slate-900 mb-6 uppercase italic tracking-tighter flex items-center gap-3">
                        <i class="fas fa-file-signature text-blue-600"></i> Syarat
                    </h3>
            ...
            {{-- Jam Pelayanan --}}
            <div class="bg-blue-950 p-8 rounded-[2.5rem] text-white shadow-2xl h-fit" data-aos="fade-left">
                <h3 class="text-lg font-black uppercase italic tracking-tighter mb-6 flex items-center gap-3 text-blue-400">
                ...
                <div class="space-y-3">
                    ...
                    <div class="p-3.5 rounded-xl bg-white/5 border border-white/10 flex justify-between items-center">
                        ...
                        <span class="text-blue-400 font-black text-xs">{{ $j['jam'] }}</span>
                    </div>
                    @endforeach
                ...
                <a href="https://wa.me/6282154199008" target="_blank" class="mt-8 flex items-center justify-center gap-3 bg-blue-600 hover:bg-blue-500 text-white py-4 rounded-xl font-black text-xs uppercase tracking-widest transition-all">
                ...
                <form onsubmit="event.preventDefault(); kirimKeWA();" class="space-y-6 md:space-y-8">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="{{ $field['type'] }}" id="{{ $field['id'] }}" required placeholder="{{ $field['placeholder'] ?? '' }}" class="w-full px-5 py-4 rounded-xl bg-slate-50 border-2 border-slate-100 focus:border-blue-500 outline-none transition-all font-bold text-slate-700 text-sm">
                        </div>
                        @endforeach

                        <div class="space-y-2">
                            <label class="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-1">5) Jenis Kelamin</label>
                            <select id="jk" required class="w-full px-5 py-4 rounded-xl bg-slate-50 border-2 border-slate-100 focus:border-blue-500 outline-none transition-all font-bold text-slate-700 text-sm appearance-none">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" id="agama" required class="w-full px-5 py-4 rounded-xl bg-slate-50 border-2 border-slate-100 focus:border-blue-500 outline-none transition-all font-bold text-slate-700 text-sm">
                        </div>

                        <div class="space-y-2 md:col-span-2">
                            <label class="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-1">7) Asal Sekolah</label>
                            <input type="text" id="asal_sekolah" required class="w-full px-5 py-4 rounded-xl bg-slate-50 border-2 border-slate-100 focus:border-blue-500 outline-none transition-all font-bold text-slate-700 text-sm">
                        </div>

                        <div class="space-y-2">
                            <label class="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-1">8a) Nama Ayah</label>
                            <input type="text" id="nama_ayah" required class="w-full px-5 py-4 rounded-xl bg-slate-50 border-2 border-slate-100 focus:border-blue-500 outline-none transition-all font-bold text-slate-700 text-sm">
                        </div>
                        <div class="space-y-2">
                            <label class="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-1">8b) Nama Ibu</label>
                            <input type="text" id="nama_ibu" required class="w-full px-5 py-4 rounded-xl bg-slate-50 border-2 border-slate-100 focus:border-blue-500 outline-none transition-all font-bold text-slate-700 text-sm">
                        </div>

                        <div class="space-y-2 md:col-span-2">
                            <label class="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-1">9) No HP Orangtua (WA)</label>
                            <input type="tel" id="hp_ortu" required placeholder="08..." class="w-full px-5 py-4 rounded-xl bg-slate-50 border-2 border-slate-100 focus:border-blue-500 outline-none transition-all font-bold text-slate-700 text-sm">
                        </div>

                        <div class="space-y-2 md:col-span-2">
                            <label class="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-1">11) Alamat Lengkap</label>
                            <textarea id="alamat" required rows="3" class="w-full px-5 py-4 rounded-xl bg-slate-50 border-2 border-slate-100 focus:border-blue-500 outline-none transition-all font-bold text-slate-700 text-sm"></textarea>
                        </div>

                        <div class="space-y-2">
                            <label class="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-1">12) Berkebutuhan Khusus?</label>
                            <select id="abk" required onchange="toggleABK()" class="w-full px-5 py-4 rounded-xl bg-slate-50 border-2 border-slate-100 focus:border-blue-500 outline-none transition-all font-bold text-slate-700 text-sm">
                        ...
                        <div class="space-y-2" id="box_jenis_abk" style="display:none;">
                            ...
                            <input type="text" id="jenis_abk" class="w-full px-5 py-4 rounded-xl bg-slate-50 border-2 border-slate-100 focus:border-blue-500 outline-none transition-all font-bold text-slate-700 text-sm">
                        </div>
                    </div>

                    <div class="pt-6">
                        <button type="submit" class="w-full bg-blue-950 text-white font-black py-5 rounded-2xl shadow-xl transition-all active:scale-95 text-xs uppercase tracking-widest flex items-center justify-center gap-4 hover:bg-blue-900">
