    ...
    <div class="max-w-7xl mx-auto px-6 relative z-10">
        <div class="max-w-3xl">
            <div class="inline-flex items-center gap-3 bg-emerald-500/10 border border-emerald-500/20 px-4 py-2 rounded-xl mb-8">
                ...
                <span class="text-emerald-400 text-xs font-black uppercase tracking-[0.2em]">Admissions</span>
            </div>

            <h1 class="text-5xl md:text-7xl font-black text-white mb-8 leading-[1.1]">
                Mari <br>
                <span class="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-emerald-600">Bergabung</span>
            </h1>
            <p class="text-slate-400 text-xl leading-relaxed max-w-2xl mb-12">
                Langkah awal menuju masa depan gemilang dimulai dari sini. Pilih jalur prestasi atau reguler sekarang.
            </p>
        </div>
...
<div class="bg-slate-50 py-24 px-6">
    <div class="max-w-4xl mx-auto bg-white rounded-[48px] shadow-2xl p-8 md:p-16 border border-slate-100">
        <h2 class="text-3xl font-black text-slate-800 mb-8 text-center uppercase tracking-tight">Formulir Minat Calon Siswa</h2>
        <form action="#" class="space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-2">
                    <label class="text-xs font-black uppercase tracking-widest text-slate-400 ml-4">Nama Lengkap</label>
                    <input type="text" placeholder="Masukkan nama" class="w-full px-6 py-4 rounded-2xl bg-slate-50 border border-slate-100 focus:ring-2 focus:ring-emerald-500 outline-none transition-all">
                </div>
                <div class="space-y-2">
                    <label class="text-xs font-black uppercase tracking-widest text-slate-400 ml-4">Asal Sekolah</label>
                    <input type="text" placeholder="Masukkan sekolah asal" class="w-full px-6 py-4 rounded-2xl bg-slate-50 border border-slate-100 focus:ring-2 focus:ring-emerald-500 outline-none transition-all">
                </div>
            </div>
            <div class="space-y-2">
                <label class="text-xs font-black uppercase tracking-widest text-slate-400 ml-4">Nomor WhatsApp Orang Tua</label>
                <input type="tel" placeholder="08xxxx" class="w-full px-6 py-4 rounded-2xl bg-slate-50 border border-slate-100 focus:ring-2 focus:ring-emerald-500 outline-none transition-all">
            </div>
            <button type="submit" class="w-full bg-emerald-600 text-white font-black py-5 rounded-2xl shadow-xl shadow-emerald-900/20 hover:bg-emerald-700 hover:scale-[1.01] transition-all duration-300">
