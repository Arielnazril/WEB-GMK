    ...
    <div class="max-w-7xl mx-auto px-6 relative z-10">
        <div class="max-w-3xl">
            <div class="inline-flex items-center gap-3 bg-emerald-500/10 border border-emerald-500/20 px-4 py-2 rounded-xl mb-8">
                ...
                <span class="text-emerald-400 text-xs font-black uppercase tracking-[0.2em]">Self Development</span>
            </div>

            <h1 class="text-5xl md:text-7xl font-black text-white mb-8 leading-[1.1]">
                Ekstra <br>
                <span class="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-emerald-600">kurikuler</span>
            </h1>
            <p class="text-slate-400 text-xl leading-relaxed max-w-2xl mb-12">
                Wadah eksplorasi bakat dan minat siswa untuk menjadi pribadi yang aktif, kreatif, dan berprestasi.
            </p>
        </div>
...
<div class="bg-slate-50 py-24">
    <div class="max-w-7xl mx-auto px-6">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div class="bg-white p-8 rounded-[40px] border border-slate-100 flex gap-6 hover:translate-y-[-10px] transition-transform duration-300 shadow-sm hover:shadow-xl">
                <div class="w-20 h-20 bg-emerald-50 text-emerald-600 rounded-3xl flex items-center justify-center text-3xl shrink-0"><i class="fas fa-robot"></i></div>
                <div>
                    <h3 class="text-xl font-bold text-slate-800 mb-2">Robotika</h3>
                    <p class="text-slate-500 text-sm">Mempelajari dasar mekanik dan pemrograman untuk solusi masa depan.</p>
                </div>
            </div>
            <div class="bg-white p-8 rounded-[40px] border border-slate-100 flex gap-6 hover:translate-y-[-10px] transition-transform duration-300 shadow-sm hover:shadow-xl">
                <div class="w-20 h-20 bg-blue-50 text-blue-600 rounded-3xl flex items-center justify-center text-3xl shrink-0"><i class="fas fa-basketball-ball"></i></div>
                <div>
                    <h3 class="text-xl font-bold text-slate-800 mb-2">Basket</h3>
                    <p class="text-slate-500 text-sm">Pengembangan kerjasama tim dan ketangkasan fisik melalui olahraga.</p>
                </div>
            </div>
            <div class="bg-white p-8 rounded-[40px] border border-slate-100 flex gap-6 hover:translate-y-[-10px] transition-transform duration-300 shadow-sm hover:shadow-xl">
                <div class="w-20 h-20 bg-amber-50 text-amber-600 rounded-3xl flex items-center justify-center text-3xl shrink-0"><i class="fas fa-music"></i></div>
                <div>
                    <h3 class="text-xl font-bold text-slate-800 mb-2">Seni Musik</h3>
                    <p class="text-slate-500 text-sm">Eksplorasi bakat bermusik lewat alat musik modern dan tradisional.</p>
                </div>
            </div>
        </div>
    </div>
